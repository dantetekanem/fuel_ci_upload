...
/**
 * Extended and adapted for FuelPHP by Leonardo Pereira (www.leonardopereira.com)
 */
...
class CI_Upload {
	...
	function CI_Upload($props = array())
	{
		...
		Log::debug("CI Upload Class Initialized");
	}
	...
	function set_error($msg)
	{
		...
		if (is_array($msg))
		{
			foreach ($msg as $val)
			{
				$msg = (Lang::get($val) == null) ? $val : Lang::get($val);	
				Log::error($msg);
				$this->error_msg[] = $msg;
			}		
		}
		...
		{
			$msg = (Lang::get($msg) == null) ? $val : Lang::get($msg);
			Log::error($msg);
			$this->error_msg[] = $msg;
		}
	}
